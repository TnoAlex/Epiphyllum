            ...
            <div class="card-header py-3 border-0 d-flex align-items-center justify-content-between">
              ...
              <div class="dropdown"><a href="#"
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="cardNotiAction">
                  <li><a class="dropdown-item" href="#"><i class="bi bi-check-lg fa-fw pe-2"></i>全部标记为阅读</a></li>
                  <li><a class="dropdown-item" href="#"><i
                      class="bi bi-bell-slash fa-fw pe-2"></i>Push notifications </a></li>
...
export default {
  ...
  methods:{
    getNotifications(pageIndex)
    {
      ...
      // console.log(winHeight,st,docHeight)

<template>
  <head>
    ...
    <meta name="description" content="Bootstrap based News, Magazine and Blog Theme"><!-- Favicon -->
  </head>
  <body>
    <HeaderNav></HeaderNav>
    <main>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="d-md-flex flex-wrap align-items-start text-center text-md-start">
                  <div class="mb-2">
                    ...
                    <div class="avatar avatar-xl">
                      <img class="avatar-img border-0" :src="this.$route.query.bigImageSrc" alt="">
                    </div>
                  </div>
                  <div class="ms-md-4 mt-3">
                    <!-- Info -->
                    <h1 class="h5 mb-0">{{this.$route.query.groupName}} <i class="bi bi-patch-check-fill text-success small"></i></h1>
                    <ul class="nav nav-divider justify-content-center justify-content-md-start">
                      <li class="nav-item"> 创建时间：{{this.$route.query.createTime}}</li>
                      <li class="nav-item"> {{this.groupPersonNum}} 人 </li>
                    </ul>
                  </div>
                ...
                <ul
                  ...
                  <li class="avatar avatar-xs" v-for="(item,index) in personInformation.slice(0,10)" :key="index">
                    <img class="avatar-img rounded-circle" :src="item.avatarImg" alt="avatar">
                  </li>
                  <li class="avatar avatar-xs me-2">
                    <div class="avatar-img rounded-circle bg-primary"><span
                        class="smaller text-white position-absolute top-50 start-50 translate-middle">+{{personInformation.length>10?10:personInformation.length}}</span></div>
                  </li>
                  <li class="small text-center">
                    {{personInformation[0].name}}, {{personInformation[1].name}}, 等
                    {{personInformation.length>10?10:personInformation.length}}人最近加入群组
                  </li>
                </ul>
                <!-- Join group END -->
              </div>
...
<!--                  <li class="nav-item"> <a class="nav-link" data-bs-toggle="tab" href="#group-tab-3"> Connections <span-->
                  ...
                  <div class="col-lg-8 vstack gap-4">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <p>I'm thrilled to share that I've completed a graduate certificate course in project management
                          with the president's honor roll.</p><!-- Card img --><img class="card-img"
                                                                                    src="assets/img/017.jpg" alt="Post"><!-- Feed react START -->
                        <ul class="nav nav-stack py-3 small">
                          <li class="nav-item"><a class="nav-link active" href="#!"><i
                              class="bi bi-hand-thumbs-up-fill pe-1"></i>Liked(56)</a></li>
                          <li class="nav-item"><a class="nav-link" href="#!"><i
                              class="bi bi-chat-fill pe-1"></i>Comments(12)</a></li><!-- Card share action START -->
                          <li class="nav-item dropdown ms-sm-auto"><a class="nav-link mb-0" href="#" id="cardShareAction8"
                        ...
                        <div class="d-flex mb-3">
                          ...
                          <form class="position-relative w-100"><textarea class="form-control pe-4 bg-light" rows="1"
                        ...
                        <ul class="comment-wrap list-unstyled">
                          ...
                          <li class="comment-item">
                            <div class="d-flex position-relative">
                              <div class="comment-line-inner"></div><!-- Avatar -->
                            ...
                            <ul class="comment-item-nested list-unstyled">
                                      ...
                                      <div class="d-flex justify-content-center">
                                        <div class="me-2">
                                          ...
                                          <p class="small mb-0">See resolved goodness felicity shy civility domestic had
                                            but Drawings offended yet answered Jennings perceive.</p>
                                        </div><small>2hr</small>
                                      </div>
                                    </div><!-- Comment react -->
                                    <ul class="nav nav-divider py-2 small">
                              ...
                              <li class="comment-item">
                                ...
                                <div class="d-flex">
                                  <!-- Avatar -->
                                  <div class="avatar avatar-story avatar-xs"><a href="#!"><img
                                      class="avatar-img rounded-circle" src="assets/img/07.jpg" alt=""></a></div>
                                  <!-- Comment by -->
                                  <div class="ms-2">
                                    <div class="bg-light p-3 rounded">
                                      <div class="d-flex justify-content-center">
                      ...
                      <div class="card-footer border-0 pt-0">
                        <!-- Load more comments --><a href="#!" role="button"
                                                      ...
                                                      data-bs-toggle="button" aria-pressed="true">
                        <div class="spinner-dots me-2"><span class="spinner-dot"></span><span
                            class="spinner-dot"></span><span class="spinner-dot"></span></div>Load more comments
                    ...
                    <div class="card">
                      ...
                      <div class="border-bottom">
                        <p class="small mb-0 px-4 py-2"><i class="bi bi-heart-fill text-danger pe-1"></i>Sam Lanson likes
                          this post</p>
                      ...
                      <div class="card-header border-0 pb-0">
                        <div class="d-flex align-items-center justify-content-between">
                          <div class="d-flex align-items-center">
                            <!-- Avatar -->
                            <div class="avatar me-2"><a href="#"><img class="avatar-img rounded-circle"
                                                                      src="assets/img/13.svg" alt=""></a></div><!-- Title -->
                            <div>
                              <h6 class="card-title mb-0"><a href="#!">Apple Education </a></h6>
                              <p class="mb-0 small">9 November at 23:29</p>
                            </div>
                          </div><!-- Card share action menu --><a href="#"
                                                                  class="text-secondary btn btn-secondary-soft-hover py-1 px-2" id="cardShareAction5"
                      ...
                      <div class="card-body pb-0">
                        ...
                        <ul class="nav nav-stack pb-2 small">
                          <li class="nav-item"><a class="nav-link active text-secondary" href="#!"><i
                              class="bi bi-heart-fill me-1 icon-xs bg-danger text-white rounded-circle"></i>Louis,Billy
                            and 126 others </a></li>
                          <li class="nav-item ms-sm-auto"><a class="nav-link" href="#!"><i
                              class="bi bi-chat-fill pe-1"></i>Comments(12)</a></li>
                        </ul><!-- Feed react END -->
                      </div><!-- Card body END -->
                      <!-- Card Footer START -->
                      <div class="card-footer py-3">
                        ...
                        <ul class="nav nav-fill nav-stack small">
                          <li class="nav-item"><a class="nav-link mb-0 active" href="#!"><i
                              class="bi bi-heart pe-1"></i>Liked(56)</a></li>
                          <li class="nav-item"><a class="nav-link mb-0" href="#!"><i
                              class="bi bi-chat-fill pe-1"></i>Comments(12)</a></li>
                          <!-- Card share action dropdown START -->
                          <li class="nav-item dropdown"><a href="#" class="nav-link mb-0" id="cardShareAction6"
                                                           data-bs-toggle="dropdown" aria-expanded="false"><i
                              class="bi bi-reply-fill flip-horizontal ps-1"></i>Share(3) </a>
                            <!-- Card share action dropdown menu -->
                          ...
                          </li><!-- Card share action dropdown END -->
                          <li class="nav-item"><a class="nav-link mb-0" href="#!"><i
                              class="bi bi-send-fill pe-1"></i>Send</a></li>
                        </ul><!-- Feed react END -->
                      </div><!-- Card Footer END -->
                    </div><!-- Card feed item END -->
                  </div>
                  <div class="col-lg-4">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body position-relative pt-0">
                        <p>{{this.$route.query.groupDescription}}</p><!-- info -->
                        <ul class="list-unstyled mt-3 mb-0">
                          <li class="mb-2"><i class="bi bi-calendar-date fa-fw pe-1"></i>总人数:<strong>{{this.groupPersonNum}} 人
                          </strong></li>
...
export default {
  ...
  methods:{
    join()
    {
      //向后端发出请求将此人的个人信息插入到该群组中
      //群组id = this.$route.query.groupId
      //如果还要多次点击就提示他已经加入

      ElMessage({
        message: '您已经加入，请勿多次点击',
        grouping: true,
        type: 'warning',
      })
